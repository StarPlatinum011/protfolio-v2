...
const About = () => {
    return (
        <div className='flex flex-col place-items-center font-work-sans bg-white text-main-text p-4 -mt-28 md:mt-12 md:px-48 md:py-12'>
            ...
            <div className='flex flex-col md:flex-row space-y-8 md:p-16 md:space-x-32'>
                ...
                <div className='flex flex-col place-items-center mb-4 mt-1 '>
                    ...
                    <p className=' text-lg md:text-2xl md:font-semibold text-balance md:pt-8 '>
