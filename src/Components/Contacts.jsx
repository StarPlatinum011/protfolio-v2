...
const Contacts = () => {
    return (
        <div className='flex flex-col font-work-sans bg-main-bg space-y-6 p-4 md:py-20 md:flex-row md:px-48 md:space-x-12'>
            <div className='flex flex-col space-y-10 items-center md:w-1/2'>
                <h1 className='text-3xl font-bold md:text-6xl font-inter mt-12 md:mt-3'>Let's get connected!</h1>
            ...
            <input type="text"  className="bg-whitesmoke  transition-all duration-300 ease-out brutal-shadow text-gray-900 text-sm focus:shadow-offset-hover md:hover:shadow-offset-hover w-full p-2.5 outline-none md:py-4 md:px-4 md:text-lg" placeholder="Your name" required />
            ...
            <button className='brutal-shadow text-base md:text-xl bg-accent-yellow w-full font-semibold md:py-4 md:px-6 px-6 py-2 md:w-1/4 md:hover:shadow-offset-hover transition-all duration-300 ease-out '>Submit</button>
            </div>
        </div>
    );
};
